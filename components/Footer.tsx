...
export default function Footer() {
  const socialLinks = [
    ...
    { platform: 'TikTok', url: '#', Icon: TikTokIcon },
  ...
  return (
    <footer className="bg-near-black text-cream border-t border-gold/20">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        {/* Social links */}
        <div className="mt-10 pt-8 border-t border-gold/10 flex justify-center gap-6">
          {socialLinks.map(({ platform, url, Icon }) => (
            <a
              key={platform}
              href={url}
              aria-label={platform}
              className="text-cream/70 hover:text-gold transition-colors focus:outline-none focus:ring-2 focus:ring-gold focus:ring-offset-2 focus:ring-offset-near-black rounded p-1"
            >
