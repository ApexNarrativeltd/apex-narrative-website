...
function TikTokIcon({ className }: { className?: string }) {
  return (
    <svg viewBox="0 0 24 24" fill="currentColor" className={className} aria-hidden="true">
      <path d="M19.59 6.69a4.83 4.83 0 0 1-3.77-4.25V2h-3.45v13.67a2.89 2.89 0 0 1-5.2 1.74 2.89 2.89 0 0 1 2.31-4.64 2.93 2.93 0 0 1 .88.13V9.4a6.84 6.84 0 0 0-1-.05A6.33 6.33 0 0 0 5.8 20.1a6.34 6.34 0 0 0 10.86-4.43V8.87a8.16 8.16 0 0 0 4.77 1.52v-3.4a4.85 4.85 0 0 1-1-.3z" />
    </svg>
  );
}
...
export default function Footer() {
  const socialLinks = [
    {
      platform: 'X',
      url: 'https://x.com/ApexNarrative',
      Icon: XIcon,
      bgStyle: { backgroundColor: '#000000' },
    },
    {
      platform: 'LinkedIn',
      url: 'https://www.linkedin.com/company/apex-narrative',
      Icon: LinkedInIcon,
      bgStyle: { backgroundColor: '#0A66C2' },
    },
    {
      platform: 'Instagram',
      url: 'https://www.instagram.com/apexnarrative',
      Icon: InstagramIcon,
      bgStyle: {
        background:
    ...
    {
      platform: 'TikTok',
      url: 'https://www.tiktok.com/@apexnarrative',
      Icon: TikTokIcon,
      bgStyle: { backgroundColor: '#000000' },
    },
  ];
    ...
    <footer className="bg-near-black text-cream border-t border-gold/20">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8">
          <div>
            <h3 className="font-bold text-cream mb-3">Company</h3>
          ...
          <div>
            <h3 className="font-bold text-cream mb-3">Services</h3>
            <ul className="space-y-2">
          ...
          <div>
            <h3 className="font-bold text-cream mb-3">Who We Work With</h3>
            <ul className="space-y-2">
        ...
        <div className="mt-10 pt-8 border-t border-gold/10 flex justify-center gap-4">
          {socialLinks.map(({ platform, url, Icon, bgStyle }) => (
            <a
              ...
              aria-label={platform}
              className="w-10 h-10 rounded-full flex items-center justify-center transition-all duration-200 hover:scale-110 focus:outline-none focus:ring-2 focus:ring-gold focus:ring-offset-2 focus:ring-offset-near-black"
              style={bgStyle}
            >
